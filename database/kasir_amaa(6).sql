...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2024 at 05:16 AM
...
(46, 4, 8, 'gacoan', 20000, 2003, '66bace89a08cf.jpg'),
...
(11, 'afkhar', 'jl telok leok', '08642234566', 'laki-laki', 1),
(12, 'daper', 'jl pramuka', '082398989', 'laki-laki', 1);
...
INSERT INTO `transaksi` (`id_transaksi`, `id_user`, `total_transaksi`, `total_diskon`, `nominal_tunai`, `ppn`, `kembalian`, `tanggal`, `invoice`, `pesan`, `id_member`, `subtotal`) VALUES
(4, 20, 20000, 0, 20000, 0, 0, '2024-08-29', 'RD298241820001', '', 10, 20000),
(5, 20, 77000, 3000, 80000, 0, 3000, '2024-08-29', 'RD298241827201', '', 10, 80000),
(6, 20, 20000, 0, 29000, 0, 9000, '2024-08-29', 'RD298241919273', '', 10, 20000),
(7, 20, 0, 0, 0, 0, 0, '2024-08-29', 'RD298241923193', '', 10, 0);
...
INSERT INTO `transaksi_detail` (`id_transaksi_detail`, `id_transaksi`, `id_barang`, `qty`, `harga`, `subtotal`) VALUES
(1, 4, 46, 1, 20000, 20000),
(2, 5, 46, 4, 20000, 80000),
(3, 6, 46, 1, 20000, 20000);
